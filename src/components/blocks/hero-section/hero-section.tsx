...
const HeroSection = ({ menudata, lng }: { menudata: MenuData[]; lng: string }) => {
        ...
        <div className='grid grid-cols-1 gap-6 gap-y-12 md:gap-y-16 lg:grid-cols-5'>
          <div className='flex w-full flex-col justify-center gap-5 max-lg:items-center lg:col-span-3 lg:h-95.5'>
            ...
            <div className='flex items-center gap-3.5'>
              ...
              >
                <Link href='#contact-us'>{t('book_table')}</Link>
              </Button>
            </div>
          </div>
            ...
            <CarouselContent>
              {menudata.map((item, index) => (
                ...
                >
                  ...
                  <p className='text-card-foreground'>{t(`hero.comments.${index}`)}</p>
                </CarouselItem>
              ))}
            </CarouselContent>
          </Carousel>

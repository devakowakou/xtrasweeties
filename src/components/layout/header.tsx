...
const Header = ({ navigationData, className, currentLang }: HeaderProps) => {
  ...
  return (
    ...
    >
      <div className='mx-auto flex h-full max-w-7xl items-center justify-between gap-6 px-4 sm:px-6 lg:px-8'>
        {/* Logo */}
        <Link href={`/${currentLang}#home`} className='flex items-center gap-3'>
          <BistroLogo />
          <span className='text-primary text-[20px] font-semibold'>{t('title')}</span>
        </Link>
        ...
        <div className='flex items-center'>
          ...
          <Tooltip>
            ...
            <TooltipContent>{t('book_table')}</TooltipContent>
          </Tooltip>
